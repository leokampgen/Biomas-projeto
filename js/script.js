...
const B = {
  floresta: {
    ...
    fauna: [
      { n: 'Jaguar', l: 'Panthera onca', d: 'Maior felino das Américas. Nada com maestria e caça tanto na terra quanto na água.', p: 'img/jaguar.webp', v: 90, s: 80, r: 75 },
      { n: 'Arara Azul', l: 'Anodorhynchus hyacinthinus', d: 'Maior psitacídeo do mundo. Constrói seus ninhos em ocos de palmeiras.', p: 'img/arara.webp', v: 70, s: 85, r: 90 },
      { n: 'Preguiça Três Dedos', l: 'Bradypus tridactylus', d: 'Habitante do dossel, move-se apenas 38 metros por dia. Seu pelo abriga algas simbióticas.', p: 'img/preguica.webp', v: 55, s: 20, r: 80 },
    ],
    particle: 'leaves',
    introCards: [
      { bg: 'img/pulmao.webp', tag: 'Amazônia', name: 'O Pulmão do Mundo', text: 'A floresta amazônica regula o ciclo hídrico de todo o continente sul-americano através dos chamados "rios voadores" — correntes de umidade que percorrem milhares de quilômetros.', big: true },
      { bg: 'img/quatro.webp', tag: 'Dossel', name: 'Estratificação Vertical', text: 'Quatro camadas distintas — solo, sub-bosque, dossel e emergentes — criam microclimas únicos habitados por espécies altamente especializadas.' },
      { bg: 'img/tucano.webp', tag: 'Biodiversidade', name: 'Capital Biológico', text: 'Em um hectare de floresta tropical podem existir mais espécies de árvores do que em toda a Europa temperada.' },
    ],
  },
  ...
  oceano: {
    ...
    fauna: [
      { n: 'Baleia Jubarte', l: 'Megaptera novaeangliae', d: 'Famosa pelos saltos acrobáticos e cantos complexos que podem durar horas nas profundezas.', p: 'img/baleia.webp', v: 100, s: 50, r: 65 },
      { n: 'Tubarão Baleia', l: 'Rhincodon typus', d: 'Maior peixe do planeta. Filtra até 6.000 litros de água por hora para se alimentar de plâncton.', p: 'img/tubarao.webp', v: 85, s: 55, r: 72 },
      { n: 'Manta Ray', l: 'Manta birostris', d: 'Maior raia do mundo, com envergadura de até 7 metros e vida de 40 anos.', p: 'img/manta.webp', v: 80, s: 65, r: 72 },
    ],
    particle: 'bubbles',
    introCards: [
      { bg: 'img/abismo.webp', tag: 'Profundezas', name: 'O Abismo Inexplorado', text: 'Menos de 20% do fundo oceânico foi mapeado com alta resolução. As fossas abissais escondem ecossistemas completos dependentes de energia química, não solar.', big: true },
      ...
      { bg: 'img/oxigenio.webp', tag: 'Zona Fótica', name: 'Fábrica de Oxigênio', text: 'O fitoplâncton oceânico produz metade do oxigênio que respiramos, absorvendo enormes quantidades de CO₂ atmosférico.' },
    ],
  },
  ...
  vulcao: {
    ...
    fauna: [
      { n: 'Tentilhão-vampiro', l: 'Geospiza difficilis septentrionalis', d: 'Ave endêmica das Galápagos que se alimenta do sangue de outras aves. Adaptação extrema desenvolvida em ilhas vulcânicas com escassez de recursos.', p: 'img/vampiro.webp', v: 65, s: 45, r: 88 },
      { n: 'Termófilo', l: 'Thermus aquaticus', d: 'Microrganismo que prospera em fontes hidrotermais acima de 70°C. Sua enzima DNA polimerase revolucionou a biotecnologia moderna.', p: 'img/termofilo.webp', v: 80, s: 25, r: 90 },
      { n: 'Iguana Terrestre', l: 'Conolophus subcristatus', d: 'Habita as ilhas vulcânicas das Galápagos. Alimenta-se de cactos e flores, sendo capaz de sobreviver semanas sem água.', p: 'img/iguana.webp', v: 80, s: 75, r: 70 },
    ],
    particle: 'embers',
    introCards: [
      { bg: 'img/vulcaogelo.webp', tag: 'Islândia', name: 'Terra de Fogo e Gelo', text: 'A Islândia é o único lugar do mundo onde a Dorsal Mesoatlântica emerge acima do nível do mar. Dois continentes se separam visivelmente a 2,5 cm por ano.', big: true },
      { bg: 'img/laboratorio.webp', tag: 'Galápagos', name: 'Laboratório da Evolução', text: 'O isolamento das ilhas vulcânicas das Galápagos produziu 9.000 espécies endêmicas em 5 milhões de anos — taxa evolutiva sem paralelo.' },
      { bg: 'img/vida.webp', tag: 'Extremófilos', name: 'Vida no Limite', text: 'Microrganismos arqueanos vivem em fontes hidrotermais a 121°C, revelando os limites extremos da bioquímica da vida.' },
    ],
  },
  ...
  montanha: {
    ...
    fauna: [
      { n: 'Leopardo das Neves', l: 'Panthera uncia', d: 'Felino fantasma das altitudes. Cauda enorme serve como manta no frio intenso das montanhas da Ásia Central.', p: 'img/leopardo.webp', v: 80, s: 88, r: 96 },
      ...
      { n: 'Lobo do Ártico', l: 'Canis lupus arctos', d: 'Subespécie do lobo cinzento adaptada ao extremo norte. Pelagem branca espessa e patas largas funcionam como raquetes de neve naturais.', p: 'img/lobo.webp', v: 80, s: 88, r: 70 },
    ],
    particle: 'snow',
    introCards: [
  ...
  deserto: {
    ...
    particle: 'sand',
    introCards: [
      { bg: 'img/desert-1.webp', tag: 'Saara', name: 'O Maior Deserto Quente', text: 'O Saara foi um savana verde há apenas 6.000 anos. A mudança climática natural transformou o ecossistema, deixando no solo fósseis de hipopótamos e crocodilos.', big: true },
      { bg: 'img/desert-2.webp', tag: 'Atacama', name: 'O Mais Árido do Planeta', text: 'Em certas partes do Atacama não chove há séculos. Mesmo assim, organismos extremófilos sobrevivem em rochas translúcidas usando a luz difusa.' },
      { bg: 'img/desert-3.webp', tag: 'Adaptação', name: 'Engenharia da Sobrevivência', text: 'O cacto pode expandir seu tronco em 20% após a chuva, armazenando centenas de litros de água em tecidos especializados.' },
    ],
  },
};
...
/* ================================================================
   ...
   ================================================================ */
(function() {
  const lbl = document.getElementById('sdot-label');
  let hideTimer = null;

  function showLabel(dot) {
    if (!lbl) return;
    const rect = dot.getBoundingClientRect();
    const midY = rect.top + rect.height / 2;
    lbl.textContent = dot.dataset.l;
  ...
  document.querySelectorAll('.sdot').forEach(d => {
    ...
    d.addEventListener('mouseenter', () => showLabel(d));
    d.addEventListener('mouseleave', hideLabel);
    d.addEventListener('focus',      () => showLabel(d));
    d.addEventListener('blur',       hideLabel);
  });

  /* Manter label visível no bioma ativo ao trocar bioma */
  const origSwitch = window.switchBiome;
  if (typeof origSwitch === 'function') {
    window.switchBiome = function(key) {
      origSwitch(key);
      const active = document.querySelector('.sdot.active');
      if (active) showLabel(active);
    };
  }
})();
